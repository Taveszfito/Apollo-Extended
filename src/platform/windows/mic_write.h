...
namespace platf::audio {
  ...
  public:
    ...
    bool use_default_render_device = false;
  ...
  private:
    ...
    bool switch_default_capture();
    void restore_default_capture();
    void render_loop();
    ...
    std::wstring previous_capture_id;
    std::wstring steam_capture_id;
