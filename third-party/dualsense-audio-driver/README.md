...
> [!IMPORTANT]
> Apollo Extended builds this vendored source as a four-channel DualSense
> controller endpoint. It is intentionally ineligible for the Windows default
> audio role, so the generic instructions below about selecting it as the
> system default do not apply. See [APOLLO_EXTENDED.md](APOLLO_EXTENDED.md).
